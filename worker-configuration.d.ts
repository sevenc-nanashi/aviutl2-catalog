/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3c841abc8be025383d3d024d4a479bef)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_PACKAGE_STATE_ENDPOINT: string;
		VITE_REMOTE: string;
		VITE_SETUP_REMOTE: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_SUBMIT_ENDPOINT" | "VITE_PACKAGE_STATE_ENDPOINT" | "VITE_REMOTE" | "VITE_SETUP_REMOTE">> {}
}
